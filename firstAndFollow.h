...
public:
    firstAndFollow(map<string,set<vector<string>>> productions, set<string> terminals, set<string> nonTerminals, string startingSymbol):production(productions), terminals(terminals), nonTerminals(nonTerminals), startingSymbol(startingSymbol){
        createProductions();
        createFirstSet();
        createFollowSet();
    }
